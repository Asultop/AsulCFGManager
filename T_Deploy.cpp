...
void T_Deploy::generateScrollPageLayout(QString CFGFileLocation, ElaFlowLayout *cVLayout) {
    ...
    CFGBreifInfo->setCardPixmap(QPixmap(":/pic/CS2.ico"));
    ...
    CFGBreifInfo->setCardFloatPixmap(QPixmap(":/pic/favicon.ico"));
    ...
    connect(CFGBreifInfo, &ElaPopularCard::popularCardButtonClicked, this, [=]() {
        ...
        DeployWindow->setUserInfoCardPixmap(QPixmap("://pic/favicon.ico"));
